...
Run the current test suite for totals and skipped checks. Some integration tests require a LibreNMS database; a skipped test is not a passing integration check.
