...
<?php
/**
 * LibreLiveTopology Backup Utility
 *
...
class BackupUtility
{
    ...
    {
        $this->log("Starting LibreLiveTopology backup at " . date('Y-m-d H:i:s'));
        ...
        $filename = "librelivetopology_backup_{$this->timestamp}.json";
    ...
    {
        $backups = glob($this->backupDir . '/librelivetopology_backup_*.json');
        ...
        foreach ($backups as $backup) {
            ...
            $timestamp = str_replace(['librelivetopology_backup_', '.json'], '', $filename);
...
// CLI interface
if ($argc < 2) {
    echo "LibreLiveTopology Backup Utility\n\n";
    echo "Usage:\n";
