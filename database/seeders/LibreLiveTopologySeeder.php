...
namespace LibreNMS\Plugins\LibreLiveTopology\Database\Seeders;
...
class LibreLiveTopologySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info('You can now view it at: /plugin/LibreLiveTopology/embed/' . $map->id);
    }
}
