#!/bin/bash
# LibreLiveTopology Deployment/Update Script
...
echo -e "${GREEN}LibreLiveTopology Deployment${NC}"
echo "========================"
...
if [ ! -f "$PLUGIN_DIR/composer.json" ]; then
    echo "Error: Not in LibreLiveTopology directory"
    exit 1
fi
...
echo ""
echo "Visit: https://your-server/plugin/LibreLiveTopology"
echo ""
