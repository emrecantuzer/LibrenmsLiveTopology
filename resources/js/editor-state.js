/**
 * LibreLiveTopology editor — shared state and cross-cutting helpers.
 *
 ...
 * `window.LLT.EditorState` so the `let`/`const` script-scoping rules of
