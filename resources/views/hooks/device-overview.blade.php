            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="list-group">
                            @foreach($maps as $map)
                                <li class="list-group-item">
                                    <a href="{{ url('plugin/LibreLiveTopology/embed/' . $map->id) }}" target="_blank" rel="noopener noreferrer" aria-label="Open map {{ $map->title ?? $map->name }}">
                        ...
                        <a href="{{ url('plugin/LibreLiveTopology') }}" class="btn btn-default btn-sm">
