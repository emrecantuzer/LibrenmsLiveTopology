        ...
        <table class="table table-condensed">
            ...
            <tbody>
                @foreach($links as $link)
                    <tr>
                        <td>
                            <a href="{{ url('plugin/LibreLiveTopology/embed/' . $link->map_id) }}" target="_blank" rel="noopener noreferrer" aria-label="Open map {{ $link->map?->title ?? $link->map?->name ?? 'Map' }}">
                        ...
                        <td>
                            <a href="{{ url('plugin/LibreLiveTopology/embed/' . $link->map_id) }}"
...
@else
<div class="alert alert-info">
    <i class="fa fa-info-circle"></i> This port is not used in any librelivetopologys.
</div>
@endif
