@php
$title = $title ?? 'LibreLiveTopology Settings';
$saved = $saved ?? false;
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('plugin.update', ['plugin' => 'LibreLiveTopology']) }}" class="form-horizontal">
            @csrf
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    ...
                    <a href="{{ route('plugin.page', ['plugin' => 'LibreLiveTopology']) }}" class="btn btn-secondary">
                        Cancel
                    </a>
                </div>
            </div>
