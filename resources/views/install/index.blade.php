...
@section('title', 'LibreLiveTopology - Installation')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="mb-0"><i class="fas fa-cog"></i> LibreLiveTopology Installation</h3>
                </div>
                <div class="card-body">
                    <!-- Requirements Check -->
                    <div class="mb-4">
                    ...
                    <div class="text-center">
                        ...
                        <div id="installSpinner" class="d-none mt-3">
                            ...
                            <span class="ml-2">Installing LibreLiveTopology...</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="bg-light p-3 rounded">
                            <code>cd /opt/librenms/html/plugins/LibreLiveTopology<br>./quick-install.sh</code>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-3">LibreLiveTopology has been successfully installed!</p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="goToPlugin()">
                    <i class="fas fa-map"></i> Go to LibreLiveTopology
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning">
                    ...
                    <ul class="mb-0 mt-2">
                        ...
                        <li>Check /var/log/librenms/librelivetopology_install.log</li>
                    </ul>
                </div>
            </div>
            <div class="modal-footer">
...
function startInstallation() {
    ...
    fetch('{{ route("librelivetopology.install.run") }}', {
        method: 'POST',
        headers: {
...
function goToPlugin() {
    window.location.href = '{{ url("plugin/LibreLiveTopology") }}';
}
