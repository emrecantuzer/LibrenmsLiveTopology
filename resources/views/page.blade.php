                ...
                <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ url('plugin/LibreLiveTopology/embed/' . $map->id) }}" target="_blank" rel="noopener noreferrer" aria-label="Open map {{ $map->name }}">
                                                {{ $map->name }}
                                            </a>
                                        </td>
                                        <td>{{ $map->title ?? '' }}</td>
                    ...
                    @else
                        <div class="alert alert-info">
                            ...
                            No topology maps have been created yet.
...
document.getElementById('confirmLegacyDeleteMapBtn')?.addEventListener('click', function() {
    ...
    fetch(`{{ url('plugin/LibreLiveTopology/map') }}/${mapId}`, {
        method: 'DELETE',
        headers: {
