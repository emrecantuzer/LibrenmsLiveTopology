...
@section('title', 'LibreLiveTopology Settings')

@section('content')
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1><i class="fas fa-cog" aria-hidden="true"></i> LibreLiveTopology Settings</h1>
            <p class="text-muted">Configure global settings for network topology maps</p>
        </div>
    </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-9">
            ...
            <form id="settings-form" method="POST" action="{{ route('plugin.update', ['plugin' => 'LibreLiveTopology']) }}">
                @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="default_width"
                                                   value="{{ config('librelivetopology.default_width', 800) }}"
                                                   min="400" max="4096">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="default_height"
                                                   value="{{ config('librelivetopology.default_height', 600) }}"
                                                   min="300" max="2048">
                                            <span class="input-group-text">px</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="refresh_interval"
                                                   value="{{ config('librelivetopology.refresh_interval', 60) }}"
                                                   min="5" max="600">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="data_retention"
                                                   value="{{ config('librelivetopology.data_retention', 30) }}"
                                                   min="1" max="365">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="timezone">
                                        @foreach(timezone_identifiers_list() as $tz)
                                            <option value="{{ $tz }}" {{ config('librelivetopology.timezone') == $tz ? 'selected' : '' }}>
                                                {{ $tz }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="threshold_warning"
                                                   value="{{ config('librelivetopology.thresholds.warning', 50) }}"
                                                   min="1" max="100">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="threshold_critical"
                                                   value="{{ config('librelivetopology.thresholds.critical', 80) }}"
                                                   min="1" max="100">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="threshold_severe"
                                                   value="{{ config('librelivetopology.thresholds.severe', 95) }}"
                                                   min="1" max="100">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="range" class="form-range" name="node_size"
                                               value="{{ config('librelivetopology.node_size', 40) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="range" class="form-range" name="label_size"
                                               value="{{ config('librelivetopology.label_size', 12) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="link_style">
                                        <option value="straight" {{ config('librelivetopology.link_style') == 'straight' ? 'selected' : '' }}>Straight</option>
                                        <option value="angled" {{ config('librelivetopology.link_style') == 'angled' ? 'selected' : '' }}>Angled</option>
                                        <option value="curved" {{ config('librelivetopology.link_style') == 'curved' ? 'selected' : '' }}>Curved</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="snmp_enabled" id="snmp-enabled"
                                               {{ config('librelivetopology.snmp.enabled', false) ? 'checked' : '' }}>
                                        <label class="form-check-label">Enable SNMP Fallback</label>
                                    </div>
                                </div>

                                <div id="snmp-options" style="{{ !config('librelivetopology.snmp.enabled') ? 'display: none;' : '' }}">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label">SNMP Version</label>
                                            <select class="form-select" name="snmp_version">
                                                <option value="2c" {{ config('librelivetopology.snmp.version') == '2c' ? 'selected' : '' }}>v2c</option>
                                                <option value="3" {{ config('librelivetopology.snmp.version') == '3' ? 'selected' : '' }}>v3</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Community String</label>
                                            <input type="text" class="form-control" name="snmp_community"
                                                   value="{{ config('librelivetopology.snmp.community', 'public') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="snmp_timeout"
                                                       value="{{ config('librelivetopology.snmp.timeout', 1000000) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="snmp_retries"
                                                   value="{{ config('librelivetopology.snmp.retries', 3) }}"
                                                   min="1" max="10">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="snmpv3_sec_name"
                                                   value="{{ config('librelivetopology.snmp.v3.sec_name', '') }}">
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="polling_interval"
                                                   value="{{ config('librelivetopology.polling_interval', 300) }}"
                                                   min="60" max="3600">
                                            <span class="input-group-text">seconds</span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="cache_ttl"
                                                   value="{{ config('librelivetopology.cache_ttl', 60) }}"
                                                   min="10" max="600">
                                            <span class="input-group-text">seconds</span>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="max_concurrent_polls"
                                               value="{{ config('librelivetopology.max_concurrent_polls', 10) }}"
                                               min="1" max="50">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="rrd_step"
                                                   value="{{ config('librelivetopology.rrd_step', 300) }}"
                                                   min="60" max="3600">
                                            <span class="input-group-text">seconds</span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="memory_limit"
                                                   value="{{ config('librelivetopology.memory_limit', 256) }}"
                                                   min="128" max="2048">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="time_limit"
                                                   value="{{ config('librelivetopology.time_limit', 300) }}"
                                                   min="30" max="3600">
                                            <span class="input-group-text">seconds</span>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="enable_compression"
                                               {{ config('librelivetopology.enable_compression', true) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="enable_lazy_loading"
                                               {{ config('librelivetopology.enable_lazy_loading', true) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="debug_mode"
                                               {{ config('librelivetopology.debug', false) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="log_level">
                                        <option value="error" {{ config('librelivetopology.log_level') == 'error' ? 'selected' : '' }}>Error</option>
                                        <option value="warning" {{ config('librelivetopology.log_level') == 'warning' ? 'selected' : '' }}>Warning</option>
                                        <option value="info" {{ config('librelivetopology.log_level') == 'info' ? 'selected' : '' }}>Info</option>
                                        <option value="debug" {{ config('librelivetopology.log_level') == 'debug' ? 'selected' : '' }}>Debug</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="api_rate_limit"
                                               value="{{ config('librelivetopology.api_rate_limit', 60) }}"
                                               min="10" max="1000">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="export_format">
                                        <option value="json" {{ config('librelivetopology.export_format') == 'json' ? 'selected' : '' }}>JSON</option>
                                        <option value="xml" {{ config('librelivetopology.export_format') == 'xml' ? 'selected' : '' }}>XML</option>
                                        <option value="csv" {{ config('librelivetopology.export_format') == 'csv' ? 'selected' : '' }}>CSV</option>
                                        <option value="png" {{ config('librelivetopology.export_format') == 'png' ? 'selected' : '' }}>PNG Image</option>
                                        <option value="pdf" {{ config('librelivetopology.export_format') == 'pdf' ? 'selected' : '' }}>PDF</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="custom_css" rows="5"
                                              placeholder="/* Add custom CSS here */">{{ config('librelivetopology.custom_css', '') }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Webhook URL</label>
                                    <input type="url" class="form-control" name="webhook_url"
                                           value="{{ config('librelivetopology.webhook_url', '') }}"
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="auto_backup"
                                               {{ config('librelivetopology.auto_backup', true) ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="backup_schedule">
                                            <option value="daily" {{ config('librelivetopology.backup_schedule') == 'daily' ? 'selected' : '' }}>Daily</option>
                                            <option value="weekly" {{ config('librelivetopology.backup_schedule') == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                            <option value="monthly" {{ config('librelivetopology.backup_schedule') == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="backup_retention"
                                                   value="{{ config('librelivetopology.backup_retention', 30) }}"
                                                   min="7" max="365">
                                            <span class="input-group-text">days</span>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="backup_path"
                                           value="{{ config('librelivetopology.backup_path', storage_path('backups/librelivetopology')) }}">
                                </div>
...
function createBackup() {
    showSettingsConfirm(
        'Create Backup',
        'Create a backup of all LibreLiveTopology data now?',
        'Create Backup',
        'btn-success',
        function() {
            showSettingsAlert('Backup creation is not yet available. Use database backups (mysqldump) to back up LibreLiveTopology data. See DEPLOYMENT.md for the backup command.', 'warning');
        }
    );
}
...
function resetToDefaults() {
    showSettingsConfirm(
        'Reset Settings',
        'Reset all LibreLiveTopology settings to their default values? This cannot be undone.',
        'Reset Settings',
        'btn-danger',
        function() {
