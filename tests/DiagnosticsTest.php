...
class DiagnosticsTest extends TestCase
{
    ...
    {
        $this->assertStringContainsString("Route::get('plugin/LibreLiveTopology/diagnostics'", $this->routes);
        $this->assertStringContainsString("'librelivetopology.diagnostics'", $this->routes);
    }
