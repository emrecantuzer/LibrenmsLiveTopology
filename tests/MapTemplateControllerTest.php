...
class MapTemplateControllerTest extends TestCase
{
    public function test_createFromTemplate_imports_required_classes(): void
    {
        ...
        $this->assertStringContainsString('use LibreNMS\Plugins\LibreLiveTopology\Models\Map;', $content);
        $this->assertStringContainsString('use LibreNMS\Plugins\LibreLiveTopology\Models\Node;', $content);
        $this->assertStringContainsString('use LibreNMS\Plugins\LibreLiveTopology\Models\Link;', $content);
    }
