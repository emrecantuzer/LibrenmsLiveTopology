...
class RoutesSmokeTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists('LibreNMS\\Plugins\\LibreLiveTopology\\Http\\Controllers\\RenderController'));
        $this->assertTrue(class_exists('LibreNMS\\Plugins\\LibreLiveTopology\\Http\\Controllers\\MapController'));
        $this->assertTrue(class_exists('LibreNMS\\Plugins\\LibreLiveTopology\\Http\\Controllers\\HealthController'));
    }

    public function testRoutesFileContainsExpectedPaths()
    {
        $routes = file_get_contents(__DIR__ . '/../routes/web.php');
        $this->assertStringContainsString('plugin/LibreLiveTopology', $routes);
