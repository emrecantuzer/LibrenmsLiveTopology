...
class TagsFeatureTest extends TestCase
{
    ...
    {
        $this->assertStringContainsString('llt-onboarding-actions', $this->indexView);
        $this->assertStringContainsString("href=\"{{ url('plugin/LibreLiveTopology/templates') }}\"", $this->indexView);
        $this->assertStringContainsString("href=\"{{ url('plugin/LibreLiveTopology/diagnostics') }}\"", $this->indexView);
