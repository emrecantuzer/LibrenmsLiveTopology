...
if (!function_exists('config')) {
    function config($key = null, $default = null) {
        ...
        if ($cfg === null) {
            $cfg = [
                'librelivetopology.default_width' => 800,
                'librelivetopology.default_height' => 600,
                'librelivetopology.colors.link_normal' => '#28a745',
                'librelivetopology.colors.link_warning' => '#ffc107',
                'librelivetopology.colors.link_critical' => '#dc3545',
                'librelivetopology.colors.node_down' => '#dc3545',
                'librelivetopology.colors.node_unknown' => '#6c757d',
                'librelivetopology.rendering.link_width' => 2,
            ];
        }
