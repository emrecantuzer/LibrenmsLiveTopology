...
class InstallFunctionsTest extends TestCase
{
    ...
    {
        $this->testDir = sys_get_temp_dir() . '/librelivetopology-test-' . bin2hex(random_bytes(16));
    ...
    public function testConfigFileCreation()
    {
        ...
        $configFile = $configDir . '/librelivetopology.php';
...
PHP;
    ...
    public function testLibreNMSPathDetection()
    {
        ...
        // Test plugin path
        $pluginPath = $mockLibreNMS . '/html/plugins/LibreLiveTopology';
    ...
    {
        $composerJson = [
            'name' => 'librenms/librelivetopology',
        ...
        $this->assertEquals('librenms/librelivetopology', $decoded['name']);
    }
    ...
    public function testComposerLaravelProviderStructure()
    {
        $composerData = [
            ...
            'extra' => [
                'laravel' => [
                    'providers' => [
                        'LibreNMS\\Plugins\\LibreLiveTopology\\LibreLiveTopologyProvider'
                    ]
                ]
            ]
        ];
