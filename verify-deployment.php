...
<?php
/**
 * LibreLiveTopology Deployment Verification Script
...
echo PHP_EOL;
echo "========================================" . PHP_EOL;
echo "  LibreLiveTopology v2 Deployment Checker" . PHP_EOL;
echo "========================================" . PHP_EOL;
echo PHP_EOL;
...
$required_files = [
    ...
    'src/LibreLiveTopologyProvider.php' => 'Service provider',
...
$hook_classes = [
    'LibreNMS\Plugins\LibreLiveTopology\Hooks\MenuEntry',
    'LibreNMS\Plugins\LibreLiveTopology\Hooks\Settings',
];
...
if (file_exists($routes_file)) {
    ...
    // Check for v2 routes
    if (strpos($routes_content, '/plugin/LibreLiveTopology') !== false ||
        strpos($routes_content, 'plugin/LibreLiveTopology') !== false) {
        pass("Routes use v2 pattern (/plugin/LibreLiveTopology)");
    } else {
...
info("Manual test: Visit http://your-server/plugin/LibreLiveTopology");
